...
// 29. Create hrms_salary_process table
/*
 * Stores the salary-process module output - the 47-column salary output
 * format generated by `start_process` in actions/salary-process-action.php.
 * One row per employee per (year, month, process_type).
 */
$salaryProcessSql = "CREATE TABLE IF NOT EXISTS hrms_salary_process (
    id INT AUTO_INCREMENT PRIMARY KEY,
    company_id INT NOT NULL DEFAULT 0,
    ...
    desig VARCHAR(100) DEFAULT '',
    uan_no VARCHAR(50) DEFAULT '',
    esic_no VARCHAR(50) DEFAULT '',
    sal_mode VARCHAR(50) DEFAULT '',
    bank_name VARCHAR(100) DEFAULT '',
    acc_no VARCHAR(100) DEFAULT '',
    ifsc_code VARCHAR(50) DEFAULT '',
    salary_year INT NOT NULL DEFAULT 0,
    salary_month INT NOT NULL DEFAULT 0,
    basic_rate DECIMAL(12,2) DEFAULT 0.00,
    gross_rate DECIMAL(12,2) DEFAULT 0.00,
    pay_day DECIMAL(8,2) DEFAULT 0.00,
    basic DECIMAL(12,2) DEFAULT 0.00,
    hra DECIMAL(12,2) DEFAULT 0.00,
    med DECIMAL(12,2) DEFAULT 0.00,
    conv DECIMAL(12,2) DEFAULT 0.00,
    edu DECIMAL(12,2) DEFAULT 0.00,
    washing DECIMAL(12,2) DEFAULT 0.00,
    spe_a DECIMAL(12,2) DEFAULT 0.00,
    ot DECIMAL(12,2) DEFAULT 0.00,
    prd_inc_atnbonus DECIMAL(12,2) DEFAULT 0.00,
    bonus DECIMAL(12,2) DEFAULT 0.00,
    gratuity DECIMAL(12,2) DEFAULT 0.00,
    leave_amt DECIMAL(12,2) DEFAULT 0.00,
    ...
    canteen DECIMAL(12,2) DEFAULT 0.00,
    time_loss DECIMAL(12,2) DEFAULT 0.00,
    uniform DECIMAL(12,2) DEFAULT 0.00,
    safety_equi DECIMAL(12,2) DEFAULT 0.00,
    facility_exp DECIMAL(12,2) DEFAULT 0.00,
    esic DECIMAL(12,2) DEFAULT 0.00,
    glwf DECIMAL(12,2) DEFAULT 0.00,
    other_ded DECIMAL(12,2) DEFAULT 0.00,
    tot_ded DECIMAL(12,2) DEFAULT 0.00,
    net_salary DECIMAL(12,2) DEFAULT 0.00,
    abry_pf VARCHAR(50) DEFAULT '',
    comp_branch VARCHAR(100) DEFAULT '',
    process_type VARCHAR(20) DEFAULT 'checklist',
    processed_by VARCHAR(100) DEFAULT '',
    processed_at TIMESTAMP NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    KEY idx_company_year_month (company_id, salary_year, salary_month),
    KEY idx_emp_code (emp_code),
    UNIQUE KEY uq_emp_period_process (company_id, emp_code, salary_year, salary_month, process_type)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;";

if ($ai_db->aiQuery($salaryProcessSql)) {
    echo "<p style='color: green;'>[OK] Table 'hrms_salary_process' verified / created successfully.</p>\n";
} else {
    echo "<p style='color: red;'>[ERROR] Failed to verify / create table 'hrms_salary_process'.</p>\n";
}
?>